...
public class ClassLoaderUtil {
     ...
     *
     */
    public static Class loadClass(String className) throws ClassNotFoundException,CommonLangException {
     ...
     * @return 已装入的类
     */
	public static Class loadClass(String className, Class referrer) throws ClassNotFoundException,CommonLangException {
     ...
     * @return 已装入的类
     */
    public static Class loadClass(String className, ClassLoader classLoader) throws ClassNotFoundException, CommonLangException {
        if (className == null) {
            return null;
        }
     ...
     *
     */
    public static Class loadServiceClass(String serviceId) throws ClassNotFoundException,CommonLangException {
     ...
     *
     */
    public static Class loadServiceClass(String serviceId, Class referrer) throws ClassNotFoundException,CommonLangException {
        ClassLoader classLoader = getReferrerClassLoader(referrer);
     ...
     *
     */
    public static Class loadServiceClass(String serviceId, ClassLoader classLoader) throws ClassNotFoundException,CommonLangException {
        if (serviceId == null) {
            return null;
        }
        ...
        if (istream == null) {
            throw new CommonLangException("Could not find " + serviceId);
        }
        ...
        try {
            ...
            throw new CommonLangException("Failed to load " + serviceId, e);
        }
    ...
    public static Class loadServiceClass(String className, String serviceId)
            throws ClassNotFoundException,CommonLangException {
     ...
     *
     */
    public static Object newInstance(String className) throws ClassNotFoundException,CommonLangException {
     ...
     *
     */
    public static Object newInstance(String className, Class referrer) throws ClassNotFoundException,CommonLangException {
     ...
     *
     */
    public static Object newInstance(String className, ClassLoader classLoader) throws ClassNotFoundException,CommonLangException {
     ...
     */
    private static Object newInstance(Class clazz) throws CommonLangException {
        if (clazz == null) {
            return null;
        }
        ...
        try {
            ...
            throw new CommonLangException("Failed to instantiate class: " + clazz.getName(),
                e);
     ...
     *
     */
    public static Object newServiceInstance(String serviceId) throws ClassNotFoundException,CommonLangException {
     ...
     *
     */
    public static Object newServiceInstance(String serviceId, Class referrer) throws ClassNotFoundException,CommonLangException {
     ...
     */
    public static Object newServiceInstance(String className, String serviceId,
        ClassLoader classLoader) throws ClassNotFoundException,CommonLangException {
