...
public class StringUtil {
    ...
    /**
     * 除去字符串头尾部的指定字符(如果为null表示除去空白字符)，如果字符串是null，依然返回null。
     * <pre>
     * StringUtil.trim(null, *)          = null
     * StringUtil.trim("", *)            = ""
    ...
    /**
     * 除去字符串头部的指定字符(如果为null表示除去空白字符)，如果字符串是null，依然返回null。
     * <pre>
     * StringUtil.trimStart(null, *)          = null
     * StringUtil.trimStart("", *)            = ""
     * StringUtil.trimStart("abc", "")        = "abc"
    ...
    /**
     * 除去字符串尾部的指定字符(如果为null表示除去空白字符)，如果字符串是null，依然返回null。
     * <pre>
     * StringUtil.trimEnd(null, *)          = null
     * StringUtil.trimEnd("", *)            = ""
     * StringUtil.trimEnd("abc", "")        = "abc"
    ...
    /**
     * 除去字符串尾部的指定字符(如果为null表示除去空白字符)，如果结果字符串是空字符串""，则返回null。
     * 
     * <p>
     * 注意，和String.trim不同，此方法使用Character.isWhitespace来判定空白，
     * 因而可以除去英文字符集之外的其它空白，如中文空格。
    ...
    /**
     * 除去字符串尾部的指定字符(如果为null表示除去空白字符)，如果字符串是null，则返回空字符串""。
     * <p>
     * 注意，和String.trim不同，此方法使用Character.isWhitespace来判定空白，
     * 因而可以除去英文字符集之外的其它空白，如中文空格。
     * <pre>
    ...
    //XXX:字符串类型判定函数(判定字符串的类型是否为：字母、数字、空白等)
    ...
    /**
     * 将字符串转换成camel case。此方法会保留除了下划线和空白以外的所有分隔符。
     * <pre>
    ...
    /**
     * 将字符串转换成pascal case。此方法会保留除了下划线和空白以外的所有分隔符。
     * <pre>
    ...
    /**
     * 将字符串转换成下划线分隔的大写字符串。此方法会保留除了空白以外的所有分隔符。
     * <pre>
    ...
    /**
     * 将字符串转换成下划线分隔的小写字符串。此方法会保留除了空白以外的所有分隔符。
     * <pre>
    ...
    public static String join(Object[] array, String separator) {
        ...
        //(估计大约所有的字符串都一样长)
        int bufSize = (arraySize == 0) ? 0 : (arraySize * (((array[0] == null) ? 16 : array[0].toString().length())
    ...
    /**
     * 在字符串中查找指定字符集合中的字符，并返回第一个匹配的起始索引。 如果字符串为null，则返回-1。
     * 如果字符集合为null或空，也返回-1。
     * <pre>
    ...
    /**
     * 在字符串中查找指定字符串集合中的字符串，并返回第一个匹配的起始索引。 如果字符串为null，则返回-1。
    ...
    /**
     * 在字符串中查找不在指定字符集合中的字符，并返回第一个匹配的起始索引。 如果字符串为null，则返回-1。
     * 如果字符集合为null或空，也返回-1。
     * <pre>
    ...
    /**
     * 从字符串尾部开始查找指定字符串集合中的字符串，并返回第一个匹配的起始索引。 如果字符串为null，则返回-1。
     * 如果字符串集合为null或空，也返回-1。
     * 如果字符串集合包括""，并且字符串不为null，则返回str.length()
     * <pre>
     ...
     * 
     * <p>
     * 如果字符串为null，则返回false。 如果字符集合为null则返回true。
     * 但是空字符串永远返回true.
     * </p>
     * <pre>
     ...
     *
     * @return 子串，如果原始串为null或未找到分隔子串，则返回null
     */
     ...
     * @param end 结束索引
     *
     * @return 被覆盖后的字符串，如果原始字符串为null，则返回null
     */
    ...
    /**
     * 反转字符串中的字符顺序。如果字符串为null，则返回null。
     * <pre>
    ...
    /**
     * 反转指定分隔符分隔的各子串的顺序。如果字符串为null，则返回null。
     * <pre>
     ...
     *
     * @param str 要反转的字符串
     * @param separatorChars 分隔符，如果为null，则默认使用空白字符
     * @param separator 用来连接子串的分隔符，如果为null，默认使用空格
     */
     ...
     * 
     * <ul>
     * <li>如果str比maxWidth短，直接返回；</li>
     * <li>否则将它转换成缩略：substring(str, 0, max-3) + "..."；</li>
     * <li>如果maxWidth小于4抛出IllegalArgumentException；</li>
     * <li>返回的字符串不可能长于指定的maxWidth。</li>
     * </ul>
     * 
     * <pre>
     ...
     * @return 字符串缩略，如果原始字符串为null则返回null
     */
     ...
     * <p>
     * 和abbreviate(String, int)类似，但是增加了一个“左边界”偏移量。
     ...
     * </pre>
     *
     * @param s 第一个字符串，如果是null，则看作空字符串
     * @param t 第二个字符串，如果是null，则看作空字符串
     *
     * @return 相似度值
     */
    public static int getLevenshteinDistance(String s, String t) {
        s     = defaultIfNull(s, EMPTY_STRING);
        t     = defaultIfNull(t, EMPTY_STRING);
